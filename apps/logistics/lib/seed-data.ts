...
export const INITIAL_VEHICLE_TYPES: Array<VehicleType & { initial_available: number }> = [
  ...
  // --- PACKAGE SERVICES (UBER FLASH BOGOTÁ) ---
  {
    id: 'pkg-motorcycle',
    service: 'package',
    name: 'Uber Flash Moto Bogotá',
  ...
  // --- FREIGHT SERVICES (UBER FREIGHT / CARGA BOGOTÁ & CUNDINAMARCA) ---
  {
    id: 'freight-cargo-van',
    service: 'freight',
    name: 'Uber Cargo Sprinter (Bogotá)',
  ...
  },
  {
    ...
    service: 'freight',
    name: 'Uber Freight Box Truck (16ft)',
  ...
  },
  {
    ...
    service: 'freight',
    name: 'Uber Heavy Freight (Siberia - Funza)',
